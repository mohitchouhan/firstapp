...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FinancialServicesReporting FinancialServicesReporting}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FinancialServicesReportingField<FieldT >
    extends EntityField<FinancialServicesReporting, FieldT>
    implements FinancialServicesReportingSelectable
{
     ...
     */
    public FinancialServicesReportingField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FinancialServicesReportingField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
