...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SalesAreaTax SalesAreaTax} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.SalesAreaTaxLink SalesAreaTaxLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SalesAreaTaxOneToOneLink<ObjectT extends VdmObject<?> >
    extends SalesAreaTaxLink<ObjectT>
    implements OneToOneLink<SalesAreaTax, ObjectT>
{
     ...
     */
    public SalesAreaTaxOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SalesAreaTax> filter(
        @Nonnull
