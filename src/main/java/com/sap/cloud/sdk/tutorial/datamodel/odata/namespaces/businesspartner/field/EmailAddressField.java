...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.EmailAddress EmailAddress}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EmailAddressField<FieldT >
    extends EntityField<EmailAddress, FieldT>
    implements EmailAddressSelectable
{
     ...
     */
    public EmailAddressField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public EmailAddressField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
