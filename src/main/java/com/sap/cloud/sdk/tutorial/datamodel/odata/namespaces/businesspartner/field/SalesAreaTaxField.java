...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SalesAreaTax SalesAreaTax}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SalesAreaTaxField<FieldT >
    extends EntityField<SalesAreaTax, FieldT>
    implements SalesAreaTaxSelectable
{
     ...
     */
    public SalesAreaTaxField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SalesAreaTaxField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
