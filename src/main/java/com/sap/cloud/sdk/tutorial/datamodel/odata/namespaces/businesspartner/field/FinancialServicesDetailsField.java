...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FinancialServicesDetails FinancialServicesDetails}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FinancialServicesDetailsField<FieldT >
    extends EntityField<FinancialServicesDetails, FieldT>
    implements FinancialServicesDetailsSelectable
{
     ...
     */
    public FinancialServicesDetailsField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FinancialServicesDetailsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
