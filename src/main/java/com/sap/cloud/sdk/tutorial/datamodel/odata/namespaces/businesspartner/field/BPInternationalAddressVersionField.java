...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPInternationalAddressVersion BPInternationalAddressVersion}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPInternationalAddressVersionField<FieldT >
    extends EntityField<BPInternationalAddressVersion, FieldT>
    implements BPInternationalAddressVersionSelectable
{
     ...
     */
    public BPInternationalAddressVersionField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPInternationalAddressVersionField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
