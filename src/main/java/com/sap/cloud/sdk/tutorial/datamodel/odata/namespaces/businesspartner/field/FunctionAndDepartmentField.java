...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FunctionAndDepartment FunctionAndDepartment}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FunctionAndDepartmentField<FieldT >
    extends EntityField<FunctionAndDepartment, FieldT>
    implements FunctionAndDepartmentSelectable
{
     ...
     */
    public FunctionAndDepartmentField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FunctionAndDepartmentField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
