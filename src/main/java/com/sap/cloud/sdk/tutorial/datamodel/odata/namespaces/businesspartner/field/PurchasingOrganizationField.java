...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PurchasingOrganization PurchasingOrganization}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PurchasingOrganizationField<FieldT >
    extends EntityField<PurchasingOrganization, FieldT>
    implements PurchasingOrganizationSelectable
{
     ...
     */
    public PurchasingOrganizationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PurchasingOrganizationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
