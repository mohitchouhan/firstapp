...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.ContactPersonAddress ContactPersonAddress} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.ContactPersonAddressLink ContactPersonAddressLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ContactPersonAddressOneToOneLink<ObjectT extends VdmObject<?> >
    extends ContactPersonAddressLink<ObjectT>
    implements OneToOneLink<ContactPersonAddress, ObjectT>
{
     ...
     */
    public ContactPersonAddressOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ContactPersonAddress> filter(
        @Nonnull
