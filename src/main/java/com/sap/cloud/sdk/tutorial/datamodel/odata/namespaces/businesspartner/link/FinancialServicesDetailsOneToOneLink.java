...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FinancialServicesDetails FinancialServicesDetails} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.FinancialServicesDetailsLink FinancialServicesDetailsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FinancialServicesDetailsOneToOneLink<ObjectT extends VdmObject<?> >
    extends FinancialServicesDetailsLink<ObjectT>
    implements OneToOneLink<FinancialServicesDetails, ObjectT>
{
     ...
     */
    public FinancialServicesDetailsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FinancialServicesDetails> filter(
        @Nonnull
