...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CreditWorthiness CreditWorthiness} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CreditWorthinessLink CreditWorthinessLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CreditWorthinessOneToOneLink<ObjectT extends VdmObject<?> >
    extends CreditWorthinessLink<ObjectT>
    implements OneToOneLink<CreditWorthiness, ObjectT>
{
     ...
     */
    public CreditWorthinessOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CreditWorthiness> filter(
        @Nonnull
