...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.TaxNumber TaxNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TaxNumberField<FieldT >
    extends EntityField<TaxNumber, FieldT>
    implements TaxNumberSelectable
{
     ...
     */
    public TaxNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TaxNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
