...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPInternationalAddressVersion BPInternationalAddressVersion} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPInternationalAddressVersionLink BPInternationalAddressVersionLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPInternationalAddressVersionOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPInternationalAddressVersionLink<ObjectT>
    implements OneToOneLink<BPInternationalAddressVersion, ObjectT>
{
     ...
     */
    public BPInternationalAddressVersionOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPInternationalAddressVersion> filter(
        @Nonnull
