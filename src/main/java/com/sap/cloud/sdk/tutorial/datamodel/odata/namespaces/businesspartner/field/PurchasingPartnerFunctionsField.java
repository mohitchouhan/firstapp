...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PurchasingPartnerFunctions PurchasingPartnerFunctions}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PurchasingPartnerFunctionsField<FieldT >
    extends EntityField<PurchasingPartnerFunctions, FieldT>
    implements PurchasingPartnerFunctionsSelectable
{
     ...
     */
    public PurchasingPartnerFunctionsField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PurchasingPartnerFunctionsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
