...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.AddressUsage AddressUsage}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressUsageField<FieldT >
    extends EntityField<AddressUsage, FieldT>
    implements AddressUsageSelectable
{
     ...
     */
    public AddressUsageField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public AddressUsageField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
