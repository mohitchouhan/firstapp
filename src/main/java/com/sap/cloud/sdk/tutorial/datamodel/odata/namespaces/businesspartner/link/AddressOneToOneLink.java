...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Address Address} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.AddressLink AddressLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class AddressOneToOneLink<ObjectT extends VdmObject<?> >
    extends AddressLink<ObjectT>
    implements OneToOneLink<Address, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Address> filter(
        @Nonnull
