...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerAddressDependentInfomation CustomerAddressDependentInfomation}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerAddressDependentInfomationField<FieldT >
    extends EntityField<CustomerAddressDependentInfomation, FieldT>
    implements CustomerAddressDependentInfomationSelectable
{
     ...
     */
    public CustomerAddressDependentInfomationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerAddressDependentInfomationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
