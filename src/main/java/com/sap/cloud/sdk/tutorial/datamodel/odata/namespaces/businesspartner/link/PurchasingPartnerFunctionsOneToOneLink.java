...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PurchasingPartnerFunctions PurchasingPartnerFunctions} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.PurchasingPartnerFunctionsLink PurchasingPartnerFunctionsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PurchasingPartnerFunctionsOneToOneLink<ObjectT extends VdmObject<?> >
    extends PurchasingPartnerFunctionsLink<ObjectT>
    implements OneToOneLink<PurchasingPartnerFunctions, ObjectT>
{
     ...
     */
    public PurchasingPartnerFunctionsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PurchasingPartnerFunctions> filter(
        @Nonnull
