...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerAddressDependentTaxNumbers BusinessPartnerAddressDependentTaxNumbers}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerAddressDependentTaxNumbersField<FieldT >
    extends EntityField<BusinessPartnerAddressDependentTaxNumbers, FieldT>
    implements BusinessPartnerAddressDependentTaxNumbersSelectable
{
     ...
     */
    public BusinessPartnerAddressDependentTaxNumbersField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerAddressDependentTaxNumbersField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
