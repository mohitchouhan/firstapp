...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerSalesAreaAddressDependentInformation CustomerSalesAreaAddressDependentInformation}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerSalesAreaAddressDependentInformationField<FieldT >
    extends EntityField<CustomerSalesAreaAddressDependentInformation, FieldT>
    implements CustomerSalesAreaAddressDependentInformationSelectable
{
     ...
     */
    public CustomerSalesAreaAddressDependentInformationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerSalesAreaAddressDependentInformationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
