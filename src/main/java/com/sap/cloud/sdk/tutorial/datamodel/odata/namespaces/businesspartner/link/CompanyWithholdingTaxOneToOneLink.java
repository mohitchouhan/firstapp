...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CompanyWithholdingTax CompanyWithholdingTax} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CompanyWithholdingTaxLink CompanyWithholdingTaxLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CompanyWithholdingTaxOneToOneLink<ObjectT extends VdmObject<?> >
    extends CompanyWithholdingTaxLink<ObjectT>
    implements OneToOneLink<CompanyWithholdingTax, ObjectT>
{
     ...
     */
    public CompanyWithholdingTaxOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CompanyWithholdingTax> filter(
        @Nonnull
