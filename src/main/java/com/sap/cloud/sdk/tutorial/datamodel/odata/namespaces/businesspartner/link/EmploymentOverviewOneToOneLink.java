...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.EmploymentOverview EmploymentOverview} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.EmploymentOverviewLink EmploymentOverviewLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EmploymentOverviewOneToOneLink<ObjectT extends VdmObject<?> >
    extends EmploymentOverviewLink<ObjectT>
    implements OneToOneLink<EmploymentOverview, ObjectT>
{
     ...
     */
    public EmploymentOverviewOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EmploymentOverview> filter(
        @Nonnull
