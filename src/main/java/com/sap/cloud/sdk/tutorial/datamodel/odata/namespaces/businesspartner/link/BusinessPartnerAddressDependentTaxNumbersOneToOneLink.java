...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerAddressDependentTaxNumbers BusinessPartnerAddressDependentTaxNumbers} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusinessPartnerAddressDependentTaxNumbersLink BusinessPartnerAddressDependentTaxNumbersLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerAddressDependentTaxNumbersOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerAddressDependentTaxNumbersLink<ObjectT>
    implements OneToOneLink<BusinessPartnerAddressDependentTaxNumbers, ObjectT>
{
     ...
     */
    public BusinessPartnerAddressDependentTaxNumbersOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerAddressDependentTaxNumbers> filter(
        @Nonnull
