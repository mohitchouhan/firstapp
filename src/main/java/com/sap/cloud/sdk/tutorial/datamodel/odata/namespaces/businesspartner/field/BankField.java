...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Bank Bank}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BankField<FieldT >
    extends EntityField<Bank, FieldT>
    implements BankSelectable
{
     ...
     */
    public BankField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BankField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
