...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PhoneNumber PhoneNumber} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.PhoneNumberLink PhoneNumberLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PhoneNumberOneToOneLink<ObjectT extends VdmObject<?> >
    extends PhoneNumberLink<ObjectT>
    implements OneToOneLink<PhoneNumber, ObjectT>
{
     ...
     */
    public PhoneNumberOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PhoneNumber> filter(
        @Nonnull
