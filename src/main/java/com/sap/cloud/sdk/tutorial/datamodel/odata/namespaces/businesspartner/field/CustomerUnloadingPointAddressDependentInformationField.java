...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerUnloadingPointAddressDependentInformation CustomerUnloadingPointAddressDependentInformation}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerUnloadingPointAddressDependentInformationField<FieldT >
    extends EntityField<CustomerUnloadingPointAddressDependentInformation, FieldT>
    implements CustomerUnloadingPointAddressDependentInformationSelectable
{
     ...
     */
    public CustomerUnloadingPointAddressDependentInformationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerUnloadingPointAddressDependentInformationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
