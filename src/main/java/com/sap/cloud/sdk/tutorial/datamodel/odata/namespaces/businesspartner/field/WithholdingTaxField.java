...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.WithholdingTax WithholdingTax}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class WithholdingTaxField<FieldT >
    extends EntityField<WithholdingTax, FieldT>
    implements WithholdingTaxSelectable
{
     ...
     */
    public WithholdingTaxField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public WithholdingTaxField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
