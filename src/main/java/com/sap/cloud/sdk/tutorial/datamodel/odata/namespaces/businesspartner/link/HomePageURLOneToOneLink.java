...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.HomePageURL HomePageURL} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.HomePageURLLink HomePageURLLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class HomePageURLOneToOneLink<ObjectT extends VdmObject<?> >
    extends HomePageURLLink<ObjectT>
    implements OneToOneLink<HomePageURL, ObjectT>
{
     ...
     */
    public HomePageURLOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<HomePageURL> filter(
        @Nonnull
