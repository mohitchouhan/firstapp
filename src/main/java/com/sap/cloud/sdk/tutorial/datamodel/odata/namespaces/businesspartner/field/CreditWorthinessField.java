...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CreditWorthiness CreditWorthiness}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CreditWorthinessField<FieldT >
    extends EntityField<CreditWorthiness, FieldT>
    implements CreditWorthinessSelectable
{
     ...
     */
    public CreditWorthinessField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CreditWorthinessField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
