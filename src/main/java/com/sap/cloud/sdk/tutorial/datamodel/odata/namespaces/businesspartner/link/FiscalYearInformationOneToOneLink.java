...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FiscalYearInformation FiscalYearInformation} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.FiscalYearInformationLink FiscalYearInformationLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FiscalYearInformationOneToOneLink<ObjectT extends VdmObject<?> >
    extends FiscalYearInformationLink<ObjectT>
    implements OneToOneLink<FiscalYearInformation, ObjectT>
{
     ...
     */
    public FiscalYearInformationOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FiscalYearInformation> filter(
        @Nonnull
