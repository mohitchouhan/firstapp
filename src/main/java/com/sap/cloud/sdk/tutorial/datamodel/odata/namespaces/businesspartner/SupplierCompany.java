    ...
    extends VdmEntity<SupplierCompany>
{
    ...
    private Boolean clearingWCustomer;
    /**
     * Use with available fluent helpers to apply the <b>ClearCustomerSupplier</b> field to query operations.
     * 
     */
    public final static SupplierCompanyField<Boolean> CLEARING_W_CUSTOMER = new SupplierCompanyField<Boolean>("ClearCustomerSupplier");
    /**
     ...
     * Constraints: none<p>Original property name from the Odata EDM: <b>ClearCustomerSupplier</b></p>
     * 
     * @param clearingWCustomer
     *     Indicator: Clearing Between Customer and Supplier?
     */
    public void setClearingWCustomer(
        @Nullable
        final Boolean clearingWCustomer) {
        rememberChangedField("ClearCustomerSupplier", this.clearingWCustomer);
        this.clearingWCustomer = clearingWCustomer;
    }
    ...
    protected Map<String, Object> toMapOfFields() {
        ...
        values.put("ClearCustomerSupplier", getClearingWCustomer());
    ...
    protected void fromMap(final Map<String, Object> inputValues) {
        ...
        // simple properties
        {
            ...
            if (values.containsKey("ClearCustomerSupplier")) {
                ...
                if ((value == null)||(!value.equals(getClearingWCustomer()))) {
                    setClearingWCustomer(((Boolean) value));
                }
            }
