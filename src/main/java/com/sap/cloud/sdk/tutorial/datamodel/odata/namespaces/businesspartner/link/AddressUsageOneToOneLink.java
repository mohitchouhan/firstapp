...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.AddressUsage AddressUsage} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.AddressUsageLink AddressUsageLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class AddressUsageOneToOneLink<ObjectT extends VdmObject<?> >
    extends AddressUsageLink<ObjectT>
    implements OneToOneLink<AddressUsage, ObjectT>
{
     ...
     */
    public AddressUsageOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<AddressUsage> filter(
        @Nonnull
