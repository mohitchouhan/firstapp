...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerDataController BusinessPartnerDataController}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerDataControllerField<FieldT >
    extends EntityField<BusinessPartnerDataController, FieldT>
    implements BusinessPartnerDataControllerSelectable
{
     ...
     */
    public BusinessPartnerDataControllerField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerDataControllerField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
