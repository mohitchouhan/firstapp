...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.ContactPersonAddress ContactPersonAddress}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ContactPersonAddressField<FieldT >
    extends EntityField<ContactPersonAddress, FieldT>
    implements ContactPersonAddressSelectable
{
     ...
     */
    public ContactPersonAddressField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ContactPersonAddressField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
