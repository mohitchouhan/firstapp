...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.AddressIndependentPhoneNumber AddressIndependentPhoneNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressIndependentPhoneNumberField<FieldT >
    extends EntityField<AddressIndependentPhoneNumber, FieldT>
    implements AddressIndependentPhoneNumberSelectable
{
     ...
     */
    public AddressIndependentPhoneNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public AddressIndependentPhoneNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
