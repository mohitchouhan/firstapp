...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.AdditionalNames AdditionalNames}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AdditionalNamesField<FieldT >
    extends EntityField<AdditionalNames, FieldT>
    implements AdditionalNamesSelectable
{
     ...
     */
    public AdditionalNamesField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public AdditionalNamesField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
