...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.HomePageURL HomePageURL}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class HomePageURLField<FieldT >
    extends EntityField<HomePageURL, FieldT>
    implements HomePageURLSelectable
{
     ...
     */
    public HomePageURLField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public HomePageURLField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
