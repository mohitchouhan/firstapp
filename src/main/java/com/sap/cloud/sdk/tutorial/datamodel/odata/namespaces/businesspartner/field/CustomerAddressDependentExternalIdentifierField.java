...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerAddressDependentExternalIdentifier CustomerAddressDependentExternalIdentifier}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerAddressDependentExternalIdentifierField<FieldT >
    extends EntityField<CustomerAddressDependentExternalIdentifier, FieldT>
    implements CustomerAddressDependentExternalIdentifierSelectable
{
     ...
     */
    public CustomerAddressDependentExternalIdentifierField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerAddressDependentExternalIdentifierField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
