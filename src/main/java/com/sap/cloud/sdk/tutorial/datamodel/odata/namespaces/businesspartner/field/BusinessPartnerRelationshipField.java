...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerRelationship BusinessPartnerRelationship}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerRelationshipField<FieldT >
    extends EntityField<BusinessPartnerRelationship, FieldT>
    implements BusinessPartnerRelationshipSelectable
{
     ...
     */
    public BusinessPartnerRelationshipField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerRelationshipField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
