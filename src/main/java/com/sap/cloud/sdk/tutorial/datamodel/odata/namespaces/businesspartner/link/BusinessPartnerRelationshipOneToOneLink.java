...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerRelationship BusinessPartnerRelationship} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusinessPartnerRelationshipLink BusinessPartnerRelationshipLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerRelationshipOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerRelationshipLink<ObjectT>
    implements OneToOneLink<BusinessPartnerRelationship, ObjectT>
{
     ...
     */
    public BusinessPartnerRelationshipOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerRelationship> filter(
        @Nonnull
