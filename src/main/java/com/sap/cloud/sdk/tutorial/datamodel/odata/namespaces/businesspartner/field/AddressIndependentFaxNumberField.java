...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.AddressIndependentFaxNumber AddressIndependentFaxNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressIndependentFaxNumberField<FieldT >
    extends EntityField<AddressIndependentFaxNumber, FieldT>
    implements AddressIndependentFaxNumberSelectable
{
     ...
     */
    public AddressIndependentFaxNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public AddressIndependentFaxNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
