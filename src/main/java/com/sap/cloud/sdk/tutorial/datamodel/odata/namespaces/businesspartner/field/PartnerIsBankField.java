...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PartnerIsBank PartnerIsBank}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PartnerIsBankField<FieldT >
    extends EntityField<PartnerIsBank, FieldT>
    implements PartnerIsBankSelectable
{
     ...
     */
    public PartnerIsBankField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PartnerIsBankField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
