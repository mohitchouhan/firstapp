...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PhoneNumber PhoneNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PhoneNumberField<FieldT >
    extends EntityField<PhoneNumber, FieldT>
    implements PhoneNumberSelectable
{
     ...
     */
    public PhoneNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PhoneNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
