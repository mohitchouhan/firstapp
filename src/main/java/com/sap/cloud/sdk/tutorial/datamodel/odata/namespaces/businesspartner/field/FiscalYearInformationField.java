...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FiscalYearInformation FiscalYearInformation}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FiscalYearInformationField<FieldT >
    extends EntityField<FiscalYearInformation, FieldT>
    implements FiscalYearInformationSelectable
{
     ...
     */
    public FiscalYearInformationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FiscalYearInformationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
