...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FaxNumber FaxNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FaxNumberField<FieldT >
    extends EntityField<FaxNumber, FieldT>
    implements FaxNumberSelectable
{
     ...
     */
    public FaxNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FaxNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
