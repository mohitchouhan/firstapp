...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FunctionAndDepartment FunctionAndDepartment} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.FunctionAndDepartmentLink FunctionAndDepartmentLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FunctionAndDepartmentOneToOneLink<ObjectT extends VdmObject<?> >
    extends FunctionAndDepartmentLink<ObjectT>
    implements OneToOneLink<FunctionAndDepartment, ObjectT>
{
     ...
     */
    public FunctionAndDepartmentOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FunctionAndDepartment> filter(
        @Nonnull
