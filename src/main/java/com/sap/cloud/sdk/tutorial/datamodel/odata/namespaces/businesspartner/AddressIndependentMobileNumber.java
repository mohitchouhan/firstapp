...
import com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.field.AddressIndependentMobileNumberField;
...
public class AddressIndependentMobileNumber
    extends VdmEntity<AddressIndependentMobileNumber>
{

    /**
     * Selector for all available fields of AddressIndependentMobileNumber.
     * 
     */
    public final static AddressIndependentMobileNumberSelectable ALL_FIELDS = () -> "*";
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> BUSINESS_PARTNER = new AddressIndependentMobileNumberField<String>("BusinessPartner");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> ADDRESS_NUMBER = new AddressIndependentMobileNumberField<String>("AddressID");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> PERSON_NUMBER = new AddressIndependentMobileNumberField<String>("Person");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> SEQUENCE_NUMBER = new AddressIndependentMobileNumberField<String>("OrdinalNumber");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> TELEPHONE_NUMBER = new AddressIndependentMobileNumberField<String>("InternationalPhoneNumber");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<Boolean> TRUE_PROPERTY = new AddressIndependentMobileNumberField<Boolean>("IsDefaultPhoneNumber");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> COUNTRY_REGION = new AddressIndependentMobileNumberField<String>("MobilePhoneCountry");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> TELEPHONE = new AddressIndependentMobileNumberField<String>("MobilePhoneNumber");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> EXTENSION = new AddressIndependentMobileNumberField<String>("PhoneNumberExtension");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<String> PHONE_NUMBER_TYPE = new AddressIndependentMobileNumberField<String>("PhoneNumberType");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<LocalDateTime> VALIDITY_START_DATE = new AddressIndependentMobileNumberField<LocalDateTime>("ValidityStartDate");
    /**
     ...
     * 
     */
    public final static AddressIndependentMobileNumberField<LocalDateTime> VALIDITY_END_DATE = new AddressIndependentMobileNumberField<LocalDateTime>("ValidityEndDate");

    @Nonnull
    @Override
    public Class<AddressIndependentMobileNumber> getType() {
    ...
    public void setCountryRegion(
        ...
        rememberChangedField("MobilePhoneCountry", this.countryRegion);
    ...
    public void setTelephone(
        ...
        rememberChangedField("MobilePhoneNumber", this.telephone);
    ...
    protected Map<String, Object> toMapOfFields() {
        ...
        values.put("MobilePhoneCountry", getCountryRegion());
        values.put("MobilePhoneNumber", getTelephone());
     ...
     */
    @Nonnull
    public static<T >AddressIndependentMobileNumberField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new AddressIndependentMobileNumberField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >AddressIndependentMobileNumberField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new AddressIndependentMobileNumberField<T>(fieldName, typeConverter);
    }
