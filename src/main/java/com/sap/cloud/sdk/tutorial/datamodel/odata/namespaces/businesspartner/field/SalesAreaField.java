...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SalesArea SalesArea}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SalesAreaField<FieldT >
    extends EntityField<SalesArea, FieldT>
    implements SalesAreaSelectable
{
     ...
     */
    public SalesAreaField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SalesAreaField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
