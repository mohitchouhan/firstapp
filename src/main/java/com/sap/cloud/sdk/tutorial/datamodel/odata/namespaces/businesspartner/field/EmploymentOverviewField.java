...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.EmploymentOverview EmploymentOverview}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EmploymentOverviewField<FieldT >
    extends EntityField<EmploymentOverview, FieldT>
    implements EmploymentOverviewSelectable
{
     ...
     */
    public EmploymentOverviewField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public EmploymentOverviewField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
