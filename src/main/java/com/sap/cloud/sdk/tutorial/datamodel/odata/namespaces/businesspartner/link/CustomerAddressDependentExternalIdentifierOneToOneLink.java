...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerAddressDependentExternalIdentifier CustomerAddressDependentExternalIdentifier} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustomerAddressDependentExternalIdentifierLink CustomerAddressDependentExternalIdentifierLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerAddressDependentExternalIdentifierOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerAddressDependentExternalIdentifierLink<ObjectT>
    implements OneToOneLink<CustomerAddressDependentExternalIdentifier, ObjectT>
{
     ...
     */
    public CustomerAddressDependentExternalIdentifierOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerAddressDependentExternalIdentifier> filter(
        @Nonnull
