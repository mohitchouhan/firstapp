...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PurchasingOrganizationText PurchasingOrganizationText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PurchasingOrganizationTextField<FieldT >
    extends EntityField<PurchasingOrganizationText, FieldT>
    implements PurchasingOrganizationTextSelectable
{
     ...
     */
    public PurchasingOrganizationTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PurchasingOrganizationTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
