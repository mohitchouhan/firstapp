...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PartnerIsBank PartnerIsBank} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.PartnerIsBankLink PartnerIsBankLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PartnerIsBankOneToOneLink<ObjectT extends VdmObject<?> >
    extends PartnerIsBankLink<ObjectT>
    implements OneToOneLink<PartnerIsBank, ObjectT>
{
     ...
     */
    public PartnerIsBankOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PartnerIsBank> filter(
        @Nonnull
