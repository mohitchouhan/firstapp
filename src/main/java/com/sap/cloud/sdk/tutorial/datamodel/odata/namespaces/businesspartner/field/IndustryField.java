...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Industry Industry}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class IndustryField<FieldT >
    extends EntityField<Industry, FieldT>
    implements IndustrySelectable
{
     ...
     */
    public IndustryField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public IndustryField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
