...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerSalesAreaAddressDependentTaxInfo CustomerSalesAreaAddressDependentTaxInfo}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerSalesAreaAddressDependentTaxInfoField<FieldT >
    extends EntityField<CustomerSalesAreaAddressDependentTaxInfo, FieldT>
    implements CustomerSalesAreaAddressDependentTaxInfoSelectable
{
     ...
     */
    public CustomerSalesAreaAddressDependentTaxInfoField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerSalesAreaAddressDependentTaxInfoField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
