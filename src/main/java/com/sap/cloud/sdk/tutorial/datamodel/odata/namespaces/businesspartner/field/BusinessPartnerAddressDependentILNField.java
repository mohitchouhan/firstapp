...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerAddressDependentILN BusinessPartnerAddressDependentILN}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerAddressDependentILNField<FieldT >
    extends EntityField<BusinessPartnerAddressDependentILN, FieldT>
    implements BusinessPartnerAddressDependentILNSelectable
{
     ...
     */
    public BusinessPartnerAddressDependentILNField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerAddressDependentILNField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
