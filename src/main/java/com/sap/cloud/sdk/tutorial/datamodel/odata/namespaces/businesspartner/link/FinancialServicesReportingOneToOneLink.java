...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.FinancialServicesReporting FinancialServicesReporting} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.FinancialServicesReportingLink FinancialServicesReportingLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FinancialServicesReportingOneToOneLink<ObjectT extends VdmObject<?> >
    extends FinancialServicesReportingLink<ObjectT>
    implements OneToOneLink<FinancialServicesReporting, ObjectT>
{
     ...
     */
    public FinancialServicesReportingOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FinancialServicesReporting> filter(
        @Nonnull
