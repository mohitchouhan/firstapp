...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Contact Contact}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ContactField<FieldT >
    extends EntityField<Contact, FieldT>
    implements ContactSelectable
{
     ...
     */
    public ContactField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ContactField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
