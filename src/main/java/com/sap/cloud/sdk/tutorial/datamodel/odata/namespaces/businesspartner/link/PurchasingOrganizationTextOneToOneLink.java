...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PurchasingOrganizationText PurchasingOrganizationText} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.PurchasingOrganizationTextLink PurchasingOrganizationTextLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PurchasingOrganizationTextOneToOneLink<ObjectT extends VdmObject<?> >
    extends PurchasingOrganizationTextLink<ObjectT>
    implements OneToOneLink<PurchasingOrganizationText, ObjectT>
{
     ...
     */
    public PurchasingOrganizationTextOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PurchasingOrganizationText> filter(
        @Nonnull
