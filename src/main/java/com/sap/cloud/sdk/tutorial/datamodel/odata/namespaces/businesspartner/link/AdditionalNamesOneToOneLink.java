...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.AdditionalNames AdditionalNames} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.AdditionalNamesLink AdditionalNamesLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class AdditionalNamesOneToOneLink<ObjectT extends VdmObject<?> >
    extends AdditionalNamesLink<ObjectT>
    implements OneToOneLink<AdditionalNames, ObjectT>
{
     ...
     */
    public AdditionalNamesOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<AdditionalNames> filter(
        @Nonnull
