...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SalesPartnerFunctions SalesPartnerFunctions} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.SalesPartnerFunctionsLink SalesPartnerFunctionsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SalesPartnerFunctionsOneToOneLink<ObjectT extends VdmObject<?> >
    extends SalesPartnerFunctionsLink<ObjectT>
    implements OneToOneLink<SalesPartnerFunctions, ObjectT>
{
     ...
     */
    public SalesPartnerFunctionsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SalesPartnerFunctions> filter(
        @Nonnull
