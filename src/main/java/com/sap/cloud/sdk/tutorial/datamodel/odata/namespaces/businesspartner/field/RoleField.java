...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Role Role}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class RoleField<FieldT >
    extends EntityField<Role, FieldT>
    implements RoleSelectable
{
     ...
     */
    public RoleField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public RoleField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
