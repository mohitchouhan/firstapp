...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SalesArea SalesArea} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.SalesAreaLink SalesAreaLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SalesAreaOneToOneLink<ObjectT extends VdmObject<?> >
    extends SalesAreaLink<ObjectT>
    implements OneToOneLink<SalesArea, ObjectT>
{
     ...
     */
    public SalesAreaOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SalesArea> filter(
        @Nonnull
