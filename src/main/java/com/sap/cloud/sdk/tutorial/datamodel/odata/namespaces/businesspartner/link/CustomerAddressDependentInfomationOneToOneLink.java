...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerAddressDependentInfomation CustomerAddressDependentInfomation} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustomerAddressDependentInfomationLink CustomerAddressDependentInfomationLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerAddressDependentInfomationOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerAddressDependentInfomationLink<ObjectT>
    implements OneToOneLink<CustomerAddressDependentInfomation, ObjectT>
{
     ...
     */
    public CustomerAddressDependentInfomationOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerAddressDependentInfomation> filter(
        @Nonnull
