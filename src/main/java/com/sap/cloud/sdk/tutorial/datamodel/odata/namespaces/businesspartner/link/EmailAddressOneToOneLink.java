...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.EmailAddress EmailAddress} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.EmailAddressLink EmailAddressLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EmailAddressOneToOneLink<ObjectT extends VdmObject<?> >
    extends EmailAddressLink<ObjectT>
    implements OneToOneLink<EmailAddress, ObjectT>
{
     ...
     */
    public EmailAddressOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EmailAddress> filter(
        @Nonnull
