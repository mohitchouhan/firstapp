...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SalesPartnerFunctions SalesPartnerFunctions}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SalesPartnerFunctionsField<FieldT >
    extends EntityField<SalesPartnerFunctions, FieldT>
    implements SalesPartnerFunctionsSelectable
{
     ...
     */
    public SalesPartnerFunctionsField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SalesPartnerFunctionsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
