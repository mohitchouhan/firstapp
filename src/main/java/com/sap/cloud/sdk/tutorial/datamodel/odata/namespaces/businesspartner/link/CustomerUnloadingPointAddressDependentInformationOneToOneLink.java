...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerUnloadingPointAddressDependentInformation CustomerUnloadingPointAddressDependentInformation} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustomerUnloadingPointAddressDependentInformationLink CustomerUnloadingPointAddressDependentInformationLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerUnloadingPointAddressDependentInformationOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerUnloadingPointAddressDependentInformationLink<ObjectT>
    implements OneToOneLink<CustomerUnloadingPointAddressDependentInformation, ObjectT>
{
     ...
     */
    public CustomerUnloadingPointAddressDependentInformationOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerUnloadingPointAddressDependentInformation> filter(
        @Nonnull
