...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Identification Identification}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class IdentificationField<FieldT >
    extends EntityField<Identification, FieldT>
    implements IdentificationSelectable
{
     ...
     */
    public IdentificationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public IdentificationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
