...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.Ratings Ratings}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class RatingsField<FieldT >
    extends EntityField<Ratings, FieldT>
    implements RatingsSelectable
{
     ...
     */
    public RatingsField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public RatingsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
