...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CompanyWithholdingTax CompanyWithholdingTax}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CompanyWithholdingTaxField<FieldT >
    extends EntityField<CompanyWithholdingTax, FieldT>
    implements CompanyWithholdingTaxSelectable
{
     ...
     */
    public CompanyWithholdingTaxField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CompanyWithholdingTaxField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
