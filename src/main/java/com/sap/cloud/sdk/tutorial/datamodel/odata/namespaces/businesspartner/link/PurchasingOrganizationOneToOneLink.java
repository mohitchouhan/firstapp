...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.PurchasingOrganization PurchasingOrganization} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.PurchasingOrganizationLink PurchasingOrganizationLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PurchasingOrganizationOneToOneLink<ObjectT extends VdmObject<?> >
    extends PurchasingOrganizationLink<ObjectT>
    implements OneToOneLink<PurchasingOrganization, ObjectT>
{
     ...
     */
    public PurchasingOrganizationOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<PurchasingOrganization> filter(
        @Nonnull
